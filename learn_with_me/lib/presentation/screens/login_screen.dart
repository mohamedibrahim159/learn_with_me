        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(top: size.height * 0.05, left: size.width*0.04),
                  child: Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        child: const Text('Back', style: TextStyle(color: Colors.black,fontFamily: 'Viga'),),
                      ),
                      ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        ElevatedButton.icon(
                          ...
                          icon: Image.asset(AppAssets.googleIcon, height: size.height*0.03,),
                        ...
                        ElevatedButton.icon(
                          ...
                          icon: Image.asset(AppAssets.facebookIcon, height: size.height*0.03,),
